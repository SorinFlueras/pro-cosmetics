...
if ( $rating_count > 0 ) : ?>
	<div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope
		...
		<div class="star-rating" title="<?php printf( __( 'Rata %s out of 5', 'yith-woocommerce-advanced-reviews' ), $average ); ?>">
		...
		<?php if ( comments_open() ) : ?><a href="#reviews" class="woocommerce-review-link" rel="nofollow">
			(<?php printf( _n( '%s recenzie custom', '%s customer reviews', $review_count, 'yith-woocommerce-advanced-reviews' ), '<span itemprop="reviewCount" class="count">' . $review_count . '</span>' ); ?>
			)</a><?php endif ?>
	</div>
