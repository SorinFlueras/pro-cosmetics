...
if ( $user ) {
	...
	$author_name = __( 'Anonim', 'yith-woocommerce-advanced-reviews' );
}
	...
	<div id="comment-<?php echo $review->ID; ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>
				...
				<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( __( 'Rate %d din 5', 'yith-woocommerce-advanced-reviews' ), $rating ) ?>">
			...
			<?php if ( $approved == '0' ) : ?>
				...
				<p class="meta"><em><?php _e( 'Comentariul dvs. a?teapta aprobarea', 'yith-woocommerce-advanced-reviews' ); ?></em></p>
