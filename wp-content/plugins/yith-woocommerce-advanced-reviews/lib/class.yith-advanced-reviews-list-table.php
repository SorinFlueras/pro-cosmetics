    ...
    class YITH_Advanced_Reviews_List_Table extends WP_List_Table
    {
        ...
        public function get_columns()
        {
            $columns = array(
                ...
                $this->ywar->custom_column_review => __('Comentari', 'yith-woocommerce-advanced-reviews'),
                $this->ywar->custom_column_author => __('Autor', 'yith-woocommerce-advanced-reviews'),
                $this->ywar->custom_column_date => __('Data', 'yith-woocommerce-advanced-reviews'),
                $this->ywar->custom_column_rating => __('Rate', 'yith-woocommerce-advanced-reviews'),
                $this->ywar->custom_column_product => __('Produs', 'yith-woocommerce-advanced-reviews')
            );
