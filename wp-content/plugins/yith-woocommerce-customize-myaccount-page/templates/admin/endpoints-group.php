            ...
            <table class="options-table form-table">
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Show the group open by default. (Please note: this option is valid only for
                        "Sidebar" style)', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
